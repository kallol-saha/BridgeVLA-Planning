...
import bridgevla.models.peract_agent as peract_agent
...
def experiment(cmd_args):
    ...
    peract_cfg = OmegaConf.load(cmd_args.peract_cfg_path)
    ...
    # !!! Dataset loading:
    train_dataset = Shelf_Packing_Dataset(data_folder,device=device_id,cameras=cmd_args.cameras,ep_per_task=cmd_args.ep_per_task)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--peract_cfg_path", type=str, default="finetune/bridgevla/configs/peract_official_config.yaml")
    parser.add_argument("--mvt_cfg_opts", type=str, default="")
    parser.add_argument("--exp_cfg_opts", type=str, default="")
    parser.add_argument("--peract_cfg_opts", type=str, default="")
