...
if __name__ == '__main__':
    ...
    dataset = SimplePolicyDataset(
        '/mnt/bn/lpy-lq/3D_VLA/Nips2025/gembench/train_dataset/keysteps_bbox_pcd/seed0/voxel1cm',
        '/mnt/bn/lpy-lq/3D_VLA/Nips2025/gembench/train_dataset/keysteps_bbox_pcd/instr_embeds_clip.npy',
